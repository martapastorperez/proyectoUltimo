...
ArrayList creferencia=new ArrayList();
ArrayList ctalla=new ArrayList();
ArrayList cunidades=new ArrayList();
ArrayList cprezo=new ArrayList();



Prenda prend= new Prenda(ctipo,creferencia,ctalla,cunidades,cprezo);
...
System.exit(0);    
    ...
    private void BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuscarActionPerformed
     ...
     txArea.append("\n Talla: "+prend.buscarTalla(this.txTalla.getText())+"\n Unidades: "+prend.buscarUnidades(Integer.parseInt(this.txUnidades.getText()))+"\n Precio: "+prend.buscarPrecio(Float.parseFloat(this.txPrezo.getText())));
